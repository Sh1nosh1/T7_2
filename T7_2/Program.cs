    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                /*Write("Enter the first name: ");      //Enter first and last name
                ...
                /*Write("Enter a word: ");      //Ask user enter a word
                string word = ReadLine();
                int letter_a = word.Split('a', 'A', 'а', 'А').Length - 1;       //Split the string into substrings and count the number of required symbols
                ...
                /*Write("Enter a sentence: ");      //Ask user enter a sentence
                string sentence = ReadLine();
                int words = sentence.Split(' ').Length;     //Split the string into substrings and count the number of spaces to understand the number of words
